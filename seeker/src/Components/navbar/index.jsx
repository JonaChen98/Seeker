    ...
    return (
        <div id="universal_nav_container">
            <div id="universal_nav_left">
                <Link to='/'><h3 id="universal_navbar_logo" className="universal_navbar_item">Seeker</h3></Link>
                <Link to='/events'><h6 id="universal_events_link" className="universal_nav_items">events</h6></Link>
                <Link to='/aboutus'><h6 id="universal_events_link" className="universal_nav_items">about</h6></Link>
            </div> 
